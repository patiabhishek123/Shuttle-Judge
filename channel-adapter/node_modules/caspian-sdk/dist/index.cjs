...
function dotenv() {
  const values = {};
  const path = (0, import_node_path.join)(process.cwd(), ".env");
  if (!(0, import_node_fs.existsSync)(path)) return values;
  for (let line of (0, import_node_fs.readFileSync)(path, "utf8").split(/\r?\n/)) {
    line = line.trim();
